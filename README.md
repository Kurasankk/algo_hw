...
Минимальная длина фрагмента для генерации химерной последовательности — 50 нуклеотидов.
Алгоритм Витерби использует логарифмы вероятностей для стабильности при длинных последовательностях.
...
```bash
# Шаг 1: Генерация тестовой химерной последовательности
python algo_hw1.py \
  --genome_low Streptomyces.fasta \
  --genome_high Clostridium.fasta \
  --chimera \
...
# Шаг 2: Декодирование и оценка точности
python algo_hw1.py \
  --genome_low Streptomyces.fasta \
  --genome_high Clostridium.fasta \
  --input chimera.fasta \
